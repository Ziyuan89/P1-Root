...
public class InsertionSortTests {
    ...
    @ParameterizedTest
    @JsonClasspathSource(value = "H3_InsertionSortTests.json", data = "alreadySortedTest")
    ...
    @ParameterizedTest
    @JsonClasspathSource(value = "H3_InsertionSortTests.json", data = "oneItemTest")
    public void testOneItem(@Property("value") Integer value) {
        ...
        call(() -> HYBRID_SORT.insertionSort(sortList, 0, 0), context,
            result -> "insertionSort() should not throw an exception.");

        assertTrue(Objects.equals(sortList.get(0), value), context,
            result -> "Calling insertionSort() on a sortList with one item should not change the value.");
    }
    ...
    @ParameterizedTest
    @JsonClasspathSource(value = "H3_InsertionSortTests.json", data = "boundsTest")
